 ...
 * Status: *Stable*
 *
 * The mlttable panel contains a sortable, pagable view of documents that. It can be arranged into
 * defined columns and offers several interactions, such as performing adhoc terms aggregations.
 * instead of query, runs a mlt query
 *
 */
define([
  'angular',
...
function (angular, app, _, kbn, moment) {
  ...
  module.controller('mlttable', function($rootScope, $scope, $modal, $q, 
    ...
    $scope.panelMeta = {
      ...
      status: "Stable",
      description: "A paginated table of records matching your query using " +
	    "the more like this query. Click on a row to " +
            "expand it and review all of the fields associated with " + 
	    "that document. <p>"
    };
